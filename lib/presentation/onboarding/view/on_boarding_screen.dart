  ...
  final List<Widget> _pages = [
    Column(
      ...
      children: [
        ...
        Row(
          children: [
            Text('통해 ', style: S2TextStyle.medium20(color: S2Color.black),),
            Text('연애 경험', style: S2TextStyle.medium20(color: S2Color.pink),),
            Text('을 쌓습니다.',style: S2TextStyle.medium20(color: S2Color.black),)
          ],
        ),

...
class ChattingDetailTextFieldWidget7 extends StatefulWidget {
  final ChatSocketService7 chatSocketService;

  const ChattingDetailTextFieldWidget7({
    super.key,
    required this.chatSocketService,
  });

  @override
  State<ChattingDetailTextFieldWidget7> createState() =>
      _ChattingDetailTextFieldWidget7State();
}

class _ChattingDetailTextFieldWidget7State extends State<ChattingDetailTextFieldWidget7> {

...
class ChattingDetailTextFieldWidget6 extends StatefulWidget {
  final ChatSocketService6 chatSocketService;

  const ChattingDetailTextFieldWidget6({
    super.key,
    required this.chatSocketService,
  });

  @override
  State<ChattingDetailTextFieldWidget6> createState() =>
      _ChattingDetailTextFieldWidget6State();
}

class _ChattingDetailTextFieldWidget6State extends State<ChattingDetailTextFieldWidget6> {

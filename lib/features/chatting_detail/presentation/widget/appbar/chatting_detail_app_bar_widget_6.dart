...
class ChattingDetailAppBarWidget6 extends StatelessWidget implements PreferredSizeWidget{
  const ChattingDetailAppBarWidget6({super.key});
      ...
      title: Padding(padding: const EdgeInsets.symmetric(horizontal: 6),
          child: Row(
            ...
            children: [
              ...
              Center(child: Text('사극체 연인', style: S2TextStyle.regular13(color: S2Color.pink),)),

...
class ChattingDetailAppBarWidget8 extends StatelessWidget implements PreferredSizeWidget{
  const ChattingDetailAppBarWidget8({super.key});
      ...
      title: Padding(padding: const EdgeInsets.symmetric(horizontal: 6),
          child: Row(
            ...
            children: [
              ...
              Center(child: Text('보호하고 싶은 연인', style: S2TextStyle.regular13(color: S2Color.pink),)),

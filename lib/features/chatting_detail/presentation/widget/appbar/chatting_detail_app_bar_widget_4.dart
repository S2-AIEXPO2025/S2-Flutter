...
class ChattingDetailAppBarWidget4 extends StatelessWidget implements PreferredSizeWidget{
  const ChattingDetailAppBarWidget4({super.key});
      ...
      title: Padding(padding: const EdgeInsets.symmetric(horizontal: 6),
          child: Row(
            ...
            children: [
              ...
              Center(child: Text('활발한 연인', style: S2TextStyle.regular13(color: S2Color.pink),)),

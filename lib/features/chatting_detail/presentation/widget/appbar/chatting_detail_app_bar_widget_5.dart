...
class ChattingDetailAppBarWidget5 extends StatelessWidget implements PreferredSizeWidget{
  const ChattingDetailAppBarWidget5({super.key});
      ...
      title: Padding(padding: const EdgeInsets.symmetric(horizontal: 6),
          child: Row(
            ...
            children: [
              ...
              Center(child: Text('나를 귀여워하는 연인', style: S2TextStyle.regular13(color: S2Color.pink),)),

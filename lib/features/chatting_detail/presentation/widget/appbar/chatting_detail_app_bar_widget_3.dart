...
class ChattingDetailAppBarWidget3 extends StatelessWidget implements PreferredSizeWidget{
  const ChattingDetailAppBarWidget3({super.key});
      ...
      title: Padding(padding: const EdgeInsets.symmetric(horizontal: 6),
          child: Row(
            ...
            children: [
              ...
              Center(child: Text('귀여운 연인', style: S2TextStyle.regular13(color: S2Color.pink),)),

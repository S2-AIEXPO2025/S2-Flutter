...
class ChattingDetailTextFieldWidget1 extends StatefulWidget {
  final ChatSocketService1 chatSocketService;

  const ChattingDetailTextFieldWidget1({
    super.key,
    required this.chatSocketService,
  });

  @override
  State<ChattingDetailTextFieldWidget1> createState() =>
      _ChattingDetailTextFieldWidget1State();
}

class _ChattingDetailTextFieldWidget1State extends State<ChattingDetailTextFieldWidget1> {

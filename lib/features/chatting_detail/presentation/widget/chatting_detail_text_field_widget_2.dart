...
class ChattingDetailTextFieldWidget2 extends StatefulWidget {
  final ChatSocketService2 chatSocketService;

  const ChattingDetailTextFieldWidget2({
    super.key,
    required this.chatSocketService,
  });

  @override
  State<ChattingDetailTextFieldWidget2> createState() =>
      _ChattingDetailTextFieldWidget1State();
}

class _ChattingDetailTextFieldWidget1State extends State<ChattingDetailTextFieldWidget2> {

...
class ChattingDetailTextFieldWidget8 extends StatefulWidget {
  final ChatSocketService8 chatSocketService;

  const ChattingDetailTextFieldWidget8({
    super.key,
    required this.chatSocketService,
  });

  @override
  State<ChattingDetailTextFieldWidget8> createState() =>
      _ChattingDetailTextFieldWidget8State();
}

class _ChattingDetailTextFieldWidget8State extends State<ChattingDetailTextFieldWidget8> {

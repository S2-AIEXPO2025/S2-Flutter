...
class ChattingDetailTextFieldWidget5 extends StatefulWidget {
  final ChatSocketService5 chatSocketService;

  const ChattingDetailTextFieldWidget5({
    super.key,
    required this.chatSocketService,
  });

  @override
  State<ChattingDetailTextFieldWidget5> createState() =>
      _ChattingDetailTextFieldWidget5State();
}

class _ChattingDetailTextFieldWidget5State extends State<ChattingDetailTextFieldWidget5> {
